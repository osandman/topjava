...
public abstract class AbstractUserServiceTest extends AbstractServiceTest {
    ...
    @Test
    public void duplicateAdminMailCreate() {
        assertThrows(DataAccessException.class, () ->
    ...
    @Test
    public void updateAdminWithEmptyRoles() {
        User updated = getAdminUpdated();
        service.update(updated);
        USER_MATCHER.assertMatch(service.get(ADMIN_ID), getAdminUpdated());
    }
